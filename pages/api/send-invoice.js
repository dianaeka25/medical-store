...
// Ganti dengan kunci API dari Resend
const resend = new Resend('re_RCVauHxx_4e5misZiXkUt9uE9FP79HWMe');
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const { data, error } = await resend.emails.send({
      from: 'dianaeka2502@dianaeka.com', // Ganti dengan email pengirim Anda
      to: customerEmail,
